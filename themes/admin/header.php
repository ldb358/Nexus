...
<body>
    <div id="header">
        ...
        <div id="nav">
            <a class="current" href="<?php echo $this->reroute->get_route('admin', 'default'); ?>"><img src="<?php echo $this->lpath ?>images/1.png" alt="control panel" /></a>
            <img class="spacer" src="<?php echo $this->lpath ?>images/div.png" alt="div" />
            <a href="<?php echo $this->reroute->get_route('admin', 'community'); ?>"><img src="<?php echo $this->lpath ?>images/2.png" alt="your site" /></a>
            <img class="spacer" src="<?php echo $this->lpath ?>images/div.png" alt="div" />
            <a href="<?php echo $this->reroute->get_route('admin', 'media'); ?>"><img src="<?php echo $this->lpath ?>images/3.png" alt="media" /></a>
            <img class="spacer" src="<?php echo $this->lpath ?>images/div.png" alt="div" />
            <a href="<?php echo $this->reroute->get_route('admin', 'socialmedia'); ?>"><img src="<?php echo $this->lpath ?>images/4.png" alt="social media" /></a>
            <img class="spacer" src="<?php echo $this->lpath ?>images/div.png" alt="div" />
            <a href="<?php echo $this->reroute->get_route('admin', 'university'); ?>"><img src="<?php echo $this->lpath ?>images/5.png" alt="university mail" /></a>
            <img class="spacer" src="<?php echo $this->lpath ?>images/div.png" alt="div" />
            ...
            <img class="spacer" src="<?php echo $this->lpath ?>images/div.png" alt="div" />
            <a href="<?php echo $this->reroute->get_route('admin', 'manager'); ?>"><img src="<?php echo $this->lpath ?>images/9.png" alt="proman" /></a>
        </div><!-- end #nav -->
    </div><!-- end #header -->
    <div id="cpinfo">
        <p class="cpinfo-left">
